...
void waitInUsbBankMode(unsigned long waitMs) {
  turnWifiOff();
  Serial.printf("[POWER] USB-bank keep-alive at 80 MHz for %lu ms.\n", waitMs);
  Serial.flush();
...
void enterCubeDeepSleep(unsigned long waitMs) {
  Serial.printf("[POWER] Power-cube deep sleep for %lu ms.\n", waitMs);
  Serial.flush();
